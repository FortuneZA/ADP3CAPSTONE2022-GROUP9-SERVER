...
public class CourseServiceTest {
    ...
    private static Course createdCourse = CourseFactory.createCourse("ICT:APP20","ICT: Applications Development","Fundamentals of application architecture in the software indsutry");
